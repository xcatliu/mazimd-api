...
const get_colors_from_string_1 = require("get-colors-from-string");
function post(ctx) {
        ...
        return yield new Promise((resolve, reject) => {
            Theme_1.default.find({ name }, (err, themes) => __awaiter(this, void 0, void 0, function* () {
                ...
                return yield theme.save().then((savedTheme) => {
                    ctx.body = {
                        url: `${config_1.default.api_origin}/themes/${savedTheme.id}`,
                        html_url: `${config_1.default.html_origin}/themes/${savedTheme.id}`,
                        id: savedTheme.id,
                        name: savedTheme.name,
                        css: savedTheme.css,
                        colors: get_colors_from_string_1.default(theme.css),
